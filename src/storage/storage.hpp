...
private:
    constexpr static const char* cStorageInstancePath = CONFIG_AOS_STORAGE_PATH "/database_instance.db";
    constexpr static const char* cStorageServicePath = CONFIG_AOS_STORAGE_PATH "/database_service.db";
