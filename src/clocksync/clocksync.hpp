...
public:
     ...
     */
    virtual Error Subscribes(ClockSyncSubscriberItf& subscriber) = 0;
     ...
     * @param subscriber clock sync notification subscriber.
     */
    virtual void Unsubscribes(ClockSyncSubscriberItf& subscriber) = 0;
};
...
public:
     ...
     * @param subscriber clock sync notification subscriber.
     */
    Error Subscribes(ClockSyncSubscriberItf& subscriber) override;
     ...
     * @param subscriber clock sync notification subscriber.
     */
    void Unsubscribes(ClockSyncSubscriberItf& subscriber) override;
