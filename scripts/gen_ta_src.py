...
To use lookup table in application generated files just should be build with application.
"""
import argparse
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(
        description="Generating source files which creates lookup"
    ...
    parser.add_argument("-o", "--out", action="store", help="Output file name (without extension)", default="output")
    parser.add_argument("-s", "--source", action="store", help="Directory with prebuilt ta")
    parser.add_argument("-t", "--table", action="store", help="table variable name", default="table")
