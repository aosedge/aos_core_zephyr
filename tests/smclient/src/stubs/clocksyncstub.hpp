...
public:
    ...
    aos::Error Subscribes(aos::zephyr::clocksync::ClockSyncSubscriberItf& subscriber) { return aos::ErrorEnum::eNone; }

    void Unsubscribes(aos::zephyr::clocksync::ClockSyncSubscriberItf& subscriber) { }
